...
class Camera {
  ...
  */
  ...
  /*
    Updates the aperture size to be the specified size, keeping screenDist
    constant.
  */
  void set_aperture_size(const double apertureW, const double apertureH);
  /*
 ...
 private:
  ...
  //focal plane parameters (as ratios of the screen width and height)
  double apertureW, apertureH;
